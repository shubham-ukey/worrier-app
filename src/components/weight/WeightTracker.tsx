...
const WeightTracker = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Weight Entry Dialog - Only for members */}
      {hasActiveMembership && (
      ...
      {/* Update Goal Dialog - Only for members */}
      {hasActiveMembership && (
        <Dialog open={isGoalDialogOpen} onOpenChange={setIsGoalDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Modify your starting weight or target weight
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleCreateGoal} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  type="number"
                  step="0.1"
                  defaultValue={weightGoal.start_weight}
                  onChange={(e) => setGoalForm(prev => ({ ...prev, startWeight: e.target.value }))}
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  type="number"
                  step="0.1"
                  defaultValue={weightGoal.target_weight || ''}
                  onChange={(e) => setGoalForm(prev => ({ ...prev, targetWeight: e.target.value }))}
